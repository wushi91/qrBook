      ...
      <div class="table-row" v-for="item in tableData">
        ...
        <div class='table-house-use' v-if="!item.isUnused">
          ...
          <el-popover
            ...
            width="150px"
            trigger="hover">
            <el-button style="display: block;margin: auto"type="primary" size="mini" @click="toRenterDetail">查看租客详情</el-button>
  ...
  export default {
    ...
    data() {
      return {
        ...
        tableData: [
          {houseName: '都市名园D栋26G', renter: '李一飞', rentdate: '2017/12/01-2018/11/30', rentmoney: '5000元'},
          {houseName: '都市名园F栋27K', renter: null, isUnused: true},
          {houseName: '都市名园D栋26A', renter: '赵磊', rentdate: '2017/12/01-2018/11/30', rentmoney: '215000元'},
          {houseName: '都市名园D栋16G', renter: '刘大磊鹏', rentdate: '2017/12/01-2018/11/30', rentmoney: '5000元'},
          {houseName: '阳光棕榈园10单元2008', renter: '李一飞', rentdate: '2017/12/01-2018/11/30', rentmoney: '5000元'},],
      }
    },
    methods: {
      addRenter:function () {
        MyUtil.linkToPath(this,'/renter/add')
      },
      toRenterDetail:function () {
        MyUtil.linkToPath(this,'/renter/detail')
      },
    }
  }
